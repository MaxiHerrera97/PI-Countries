...
import CardsCon from '../../Components/CardsCon/CardsCon';
import Pagination from '../../Components/Pagination/Pagination';
import Loading from "../../components/Loading/Loading";
import { useEffect } from 'react';
import {useDispatch, useSelector} from "react-redux";
import {getCountries, getActivities, sortByName, sortByPopulation, filterContinent, filterActivity, reset} from "../../redux/Actions/actions";
  ...
  return (
    <div className={stylesHome.divHome}>
      ...
      <div className={stylesHome.divCards}>
        <CardsCon currentCountries={currentCountries}/>
      </div>
