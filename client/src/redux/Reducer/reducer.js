import  {GET_COUNTRIES, GET_COUNTRY_BY_NAME, NEXT_PAGE, PREV_PAGE, NUMBER_PAGE, GET_COUNTRY_BY_ID, CLEAN_DETAIL, GET_ACTIVITY_BY_ID, CLEAN_ACTIVITY, POST_ACTIVITY, RESET, GET_ACTIVITIES, SORT_BY_NAME, SORT_BY_POPULATION, FILTER_CONTINENT, FILTER_ACTIVITY, DELETE_ACTIVITY, PUT_ACTIVITY_BY_ID, LOADING, NO_LOADING} from "../Actions/actionsTypes";
...
const reducer = (state = initialState, {type, payload}) =>{
    switch (type) {
        ...
        case FILTER_CONTINENT:
            return{
                ...state,
                countries: state.countries.filter(country => country.continent === payload),
                numPage: 1,
            };
        case FILTER_ACTIVITY:
            return{
                ...state,
                countries: state.countries.filter(country => country.Activities
